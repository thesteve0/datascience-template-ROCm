...
elif [ "$IDE_CHOICE" = "jetbrains" ]; then
    echo "✓ JetBrains devcontainer configured"
    echo "  Note: .idea/ directory will be auto-generated by JetBrains"
elif [ "$IDE_CHOICE" = "both" ]; then
    echo "✓ VSCode and JetBrains devcontainer configured"
    echo "  Note: .idea/ directory will be auto-generated by JetBrains"
fi
